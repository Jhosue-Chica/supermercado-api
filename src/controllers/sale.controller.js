...
exports.getSalesStats = async (req, res) => {
  try {
    ...
    // Estructurar datos como espera el frontend
    const stats = {
      // Estructura anidada summary como espera el frontend
      summary: {
        totalSales,
      ...
      // Renombrar totalAmount a totalSold como espera el frontend
      topProducts: topProducts.map(p => ({
        productId: p._id.productId,
        productName: p._id.productName,
        quantity: p.totalQuantity,
        totalSold: p.totalAmount  // Frontend espera totalSold, no totalAmount
      })),
